...
"카드해설":[
        ...
        "해석" : "첫번째 카드는 (카드이름 -한글형태(영어형태)로 출력)이구나. 이 카드는 이러한 메시지를 담고있단다. 너의 상황에서 이렇게 해석해 볼 수 있겠구나."
        }},
    ...
    ],
...
"카드해설" : "이러한 상황에서 (카드이름)은 이러한 의미를 가지고 있어. 네가 이러한 것을 해보면 좋겠구나."
"종합의견" : "결론적으로 (질문의 주요 내용)은 이러해 보인단다. (응원의 말 또는 다른 질문이 있는지 질의). 🤶🏻🧶"
}}
"""